...
import org.ast.labs.calview.utils.ColorUtils;
import org.ast.labs.calview.utils.DateFormats;
import org.ast.labs.calview.utils.DateUtils;
import org.ast.labs.calview.utils.InterfaceUtils;
import org.ast.labs.calview.utils.StyledResources;
import org.ast.labs.calview.view.abs.ScrollableChart;
...
import static org.ast.labs.calview.model.Checkmark.CHECKED_EXPLICITLY;
import static org.ast.labs.calview.model.Checkmark.UNCHECKED;
import static org.ast.labs.calview.model.Checkmark.*;
...
public class HistoryChart extends ScrollableChart
{
    ...
    public HistoryChart(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        init();
        Log.e("HISTORY", " History chart called");
    }
    ...
    {
        @RequiresApi(api = Build.VERSION_CODES.N)
        void onToggleCheckmark(long timestamp);
    }
}
